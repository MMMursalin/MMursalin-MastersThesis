...
%------------------------------------------------------------
\newcommand{\Title}{A Simple model for the Complex Cytoplasm} 	% Manuscript title goes here.
\newcommand{\shortTitle}{Something Cool} 		% Short title for header goes here, less than 60 characters.
\newcommand{\Author}{Mubarrat Mahin Mursalin et al.\xspace}    	% First author goes here.
...
\FrontMatter{In this work we did something}
[]%
{
\keywords{}	% add up to six keywords in curly braces {}
}
